...
genes_of_interest <- read.delim(text = "NF1
 ...
 ASXL1", header = F)
output <- output %>%
  filter(gene %in% genes_of_interest$V1)
...
chisq_test_atrx_tp53$p.value # 0.044

# stratified by age and sex
chisq.test(x = mat_atrx_tp53 %>%
             filter(Age == "14-33.5") %>% pull(ATRX), 
           y = mat_atrx_tp53 %>%
             filter(Age == "14-33.5") %>% pull(TP53)) # 0.2893
chisq.test(x = mat_atrx_tp53 %>%
             filter(Age == "0-14") %>% pull(ATRX), 
           y = mat_atrx_tp53 %>%
             filter(Age == "0-14") %>% pull(TP53)) # 0.2051
chisq.test(x = mat_atrx_tp53 %>%
             filter(Sex == "Male") %>% pull(ATRX), 
           y = mat_atrx_tp53 %>%
             filter(Sex == "Male") %>% pull(TP53)) # 0.1468
chisq.test(x = mat_atrx_tp53 %>%
             filter(Sex == "Female") %>% pull(ATRX), 
           y = mat_atrx_tp53 %>%
             filter(Sex == "Female") %>% pull(TP53)) # 0.4167
chisq.test(x = mat_atrx_tp53 %>%
             filter(Age == "0-14", 
                    Sex == "Female") %>% pull(ATRX), 
           y = mat_atrx_tp53 %>%
             filter(Age == "0-14", 
                    Sex == "Female") %>% pull(TP53)) # 0.6792
chisq.test(x = mat_atrx_tp53 %>%
             filter(Age == "0-14", 
                    Sex == "Male") %>% pull(ATRX), 
           y = mat_atrx_tp53 %>%
             filter(Age == "0-14", 
                    Sex == "Male") %>% pull(TP53)) # 0.5186
...
round(chisq_test_h3f3a_tp53$p.value, 3) # 0.014
...
chisq.test(x = mat_h3f3a_tp53 %>%
           ...
           y = mat_h3f3a_tp53 %>%
             filter(Age == "0-14") %>% pull(TP53)) # 0.06168
chisq.test(x = mat_h3f3a_tp53 %>%
...
chisq.test(x = mat_h3f3a_tp53 %>%
           ...
           y = mat_h3f3a_tp53 %>%
             filter(Sex == "Female") %>% pull(TP53)) # 0.1167
chisq.test(x = mat_h3f3a_tp53 %>%
             filter(Age == "0-14", 
                    Sex == "Female") %>% pull(H3F3A), 
           y = mat_h3f3a_tp53 %>%
             filter(Age == "0-14", 
                    Sex == "Female") %>% pull(TP53)) # 0.3345
chisq.test(x = mat_h3f3a_tp53 %>%
             filter(Age == "0-14", 
                    Sex == "Male") %>% pull(H3F3A), 
           y = mat_h3f3a_tp53 %>%
             filter(Age == "0-14", 
                    Sex == "Male") %>% pull(TP53)) # 0.2915
...
round(chisq_test_h3f3a_tp53_sex$p.value, 3) # 1
...
round(chisq_test_nf1_atrx$p.value, 3) # 0.006

# stratified by age and sex
chisq.test(x = mat_nf1_atrx %>%
             filter(Age == "14-33.5") %>% pull(NF1), 
           y = mat_nf1_atrx %>%
             filter(Age == "14-33.5") %>% pull(ATRX)) # 0.8738
chisq.test(x = mat_nf1_atrx %>%
...
chisq.test(x = mat_nf1_atrx %>%
           ...
           y = mat_nf1_atrx %>%
             filter(Sex == "Male") %>% pull(ATRX)) # 0.1941
chisq.test(x = mat_nf1_atrx %>%
             filter(Sex == "Female") %>% pull(NF1), 
           y = mat_nf1_atrx %>%
             filter(Sex == "Female") %>% pull(ATRX)) # 0.03304
chisq.test(x = mat_nf1_atrx %>%
             filter(Age == "0-14", 
                    Sex == "Female") %>% pull(NF1), 
           y = mat_nf1_atrx %>%
