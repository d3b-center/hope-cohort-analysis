...
proteomics <- read_tsv(file.path(data_dir, "cluster_data101922.tsv"))
...
single_cell_rnaseq_10x <- readxl::read_xlsx(file.path(data_dir, "CPTAC_Project Hope cohorts.xlsx"), sheet = "Aaron's Manifest")
...
single_cell_rnaseq_smartseq2 <- readxl::read_xlsx(file.path(data_dir, "single_cell_smartseq_manifest.xlsx"))
