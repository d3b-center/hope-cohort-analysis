...
ha = HeatmapAnnotation(df = annot_info , col = list(
  Sequencing_Experiment = c("WGS" = "#009999",
                            "RNA-Seq" = "#bac964",
                            "RNA-Seq, WGS" = "#5a3d55"),
  Tumor_Descriptor = c("Primary" = "#d8b9c3",
                       "Progressive" = "#827397", 
                       "Initial CNS Tumor" = "#cee397",
                       "Deceased - No Sample Collection" = "#4d4c7d",
                       "Autopsy" = "#4d4c7d",
                       "Recurrence" = "#363062",
                       "Second Malignancy" = "#005082"),
  Integrated_Diagnosis = c("Glioblastoma" = "#e1f4f3",
                           "High-grade glioma/astrocytoma (WHO grade III/IV)"="#706c61",
                           "Astrocytoma" = "#347474",
                           "Ependymoma" = "#005082")),
