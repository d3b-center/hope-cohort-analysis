...
pdf(file = file.path(output_dir, "cascade_plot_three_age_groups.pdf"), width = 16, height = 8) 
...
pdf(file = file.path(output_dir, "cascade_orderby_age_three_age_groups.pdf"), width = 16, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
...
pdf(file = file.path(output_dir, "cascade_orderby_sex_three_age_groups.pdf"), width = 16, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
