...
ha = HeatmapAnnotation(df = annot_info %>% dplyr::select(-c(`Sequencing Experiment`)), col = list(
  TMB = col_fun_tmb,
  ...
  `Molecular Subtype` = c("DMG, H3 K28" = "#053061",
                          ...
                          "HGG, IDH" = "#B3DE69",
                          "Flag" = "#f1f1f1"),
  `Diagnosis Type` = c("Initial CNS Tumor" = "#cee397",
                       "Progressive" = "#827397",
                       "Recurrence" = "#363062",
                       "Second Malignancy" = "#005082"),
  `Tumor Location` = c("Cortical" = "#D4806C",
                       "Other/Multiple locations/NOS" = "#7C8F97",
                       "Midline" = "#344C68",
                       "Cerebellar" = "#94004C"),
  `CNS region` = c("Posterior fossa" = "#D4806C",
                   "Other" = "#7C8F97",
                   "Midline" = "#344C68",
                   "Hemispheric" = "#94004C",
                   "Mixed" = "darkgreen"),
...
pdf(file = file.path(output_dir, "cascade_two_age_groups_allgenes.pdf"), width = 16, height = 12) 
...
pdf(file = file.path(output_dir, "cascade_two_age_groups_orderby_age_allgenes.pdf"), width = 16, height = 12) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
...
pdf(file = file.path(output_dir, "cascade_two_age_groups_orderby_sex_allgenes.pdf"), width = 16, height = 12) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
