...
snv_fus_genes_to_keep <- names(snv_fus_genes_to_keep[snv_fus_genes_to_keep >= 6])
cnv_dge_genes_to_keep = apply(mat, 1, FUN = function(x) 
  (length(grep("GAI|LOS|OVE|UNE", x))/ncol(mat))*100)
cnv_dge_genes_to_keep <- names(cnv_dge_genes_to_keep[cnv_dge_genes_to_keep >= 50])
...
pdf(file = file.path(output_dir, "oncoplot_norna.pdf"), width = 15, height = 8) 
...
pdf(file = file.path(output_dir, "oncoplot_orderby_sex_norna.pdf"), width = 15, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
...
pdf(file = file.path(output_dir, "oncoplot_orderby_H3F3A_norna.pdf"), width = 15, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
...
pdf(file = file.path(output_dir, "oncoplot_orderby_sex_H3F3A_status_norna.pdf"), width = 15, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
...
pdf(file = file.path(output_dir, "oncoplot_orderby_sex_age_norna.pdf"), width = 15, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
...
pdf(file = file.path(output_dir, "oncoplot_orderby_sex_age_H3F3A_status_norna.pdf"), width = 15, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
...
pdf(file = file.path(output_dir, "oncoplot_orderby_age_norna.pdf"), width = 15, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
...
pdf(file = file.path(output_dir, "oncoplot_orderby_age_H3F3A_status_norna.pdf"), width = 15, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
...
pdf(file = file.path(output_dir, "oncoplot_orderby_age_sex_H3F3A_status_norna.pdf"), width = 15, height = 8) 
draw(ht,merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right")
dev.off()
