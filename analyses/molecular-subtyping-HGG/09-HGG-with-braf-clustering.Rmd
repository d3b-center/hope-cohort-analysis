...
# for additional samples, this part can be modified to include all RNA library types later
...
# Read in metadata
metadata <-
  readr::read_tsv(file.path("..","..","data", "histologies-base.tsv"), 
                  guess_max = 100000) %>%
...
stranded_tsne_aligned_scores <- stranded_tsne_aligned_scores %>%
  ...
  mutate(subtype_class = case_when(
    BRAF_V600E == "p.V600E" &
      ...
      `H3F3A_H3-3A.G35R` == "No" &
      `H3F3A_H3-3A.G35V` == "No" ~ "HGAT_NO_HISTONE_BRAF",
