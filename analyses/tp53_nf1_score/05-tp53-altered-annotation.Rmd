...
input_dir <- file.path(root_dir,
                       ...
                       "input")
# cell composition
# cell_line_composition <- read_tsv(file.path(root_dir,
#                                            "scratch",
...
# No cell line composition for this module
...
```{r}
consensus_tp53_snv_indel <- readr::read_rds(
  file.path(data_dir,"Hope-consensus-mutation.maf.rds")) %>%
  select("Chromosome",
         "Start_Position",
         "End_Position",
         "Strand",
