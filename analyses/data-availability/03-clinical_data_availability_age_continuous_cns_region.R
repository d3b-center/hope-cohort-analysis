...
col_annot <- c("Treatment naive" = "lightgray",
               ...
               "Post-mortem" = "black")
col_tumor_loc <- c("Posterior fossa" = "#D4806C",
                   "Other" = "#7C8F97",
                   "Midline" = "#344C68",
                   "Hemispheric" = "#94004C",
                   "Mixed" = "darkgreen")
...
# generate plot 
circos.clear()
pdf(file = file.path(output_dir, "hope_clinical_data_availability_age_continuous_cns_region.pdf"), width = 10, height = 10)
