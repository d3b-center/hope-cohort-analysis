# Function: data availability heatmap with three age groups
...
# generate plot
circos.clear()
pdf(file = file.path(output_dir, "hope_clinical_data_availability_age_three_groups.pdf"), width = 10, height = 10)
