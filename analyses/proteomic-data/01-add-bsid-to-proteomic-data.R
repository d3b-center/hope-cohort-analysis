...
whole_cell_protein <- data.table::fread(file.path(input_dir, "harmonized_proteome_imputed_data_061623.tsv"))
pho <- data.table::fread(file.path(input_dir, "harmonized_phosphosite_imputed_data_ischemia_removed_062823.tsv"))
pho_motif <- data.table::fread(file.path(input_dir, "harmonized_phosphosite_imputed_data_ischemia_removed_motif_070323.tsv"))
...
## save the file
write_tsv(whole_cell_protein, file.path(output_dir, "Hope_proteome_imputed_data_061623.tsv"))
