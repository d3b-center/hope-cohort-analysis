...
p1 <- ggplot(HGG_race, aes(y = Freq, stratum = Group, alluvium = alluvium, x= x, fill = Group)) + 
  geom_alluvium() + 
  geom_stratum() +
  scale_fill_manual(values = c("Asian" = "darkorange", "SAS" = "goldenrod1", "EAS" = "tan", 
                                "White" = "firebrick4", "EUR" = "lightpink", 
                                "Black or African American" = "royalblue4", "AFR" = "steelblue1", 
                                "Native Hawaiian or Other Pacific Islander" = "olivedrab", "AMR" = "orchid4", 
                                "Reported Unknown" = "black", "Other" = "ivory4")) + 
  xlab("") + 
  theme_Publication()
