...
tp53_score <- tp53_score %>% 
  mutate(SNV_alt = case_when(!is.na(HGVSp_Short) ~ "SNV", TRUE ~ "None"),
...
```{r}
ggsave(file.path(plots_dir, "boxplot_tp53_score_status.pdf"))
...
```{r}
ggsave(file.path(plots_dir, "boxplot_tp53_score_subtype.pdf"))
