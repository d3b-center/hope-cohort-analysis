...
ggsave(file.path(plots_dir, "HR_race.png"), width = 10, height = 6)
...
ggsave(file.path(plots_dir, "HR_DMG.png"), width = 10, height = 6)
...
names(DMG_model$coefficients) <- c(names(DMG_model$coefficients)[1:6], "DMG, H3 K28 * tp53_score")
plotForest(DMG_model)
...
ggsave(file.path(plots_dir, "HR_DMG_tp53_interaction.png"), width = 8, height = 6)
